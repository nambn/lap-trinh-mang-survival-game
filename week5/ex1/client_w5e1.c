/*
* @Author: nam
* @Date:   2018-10-18 12:25:23
* @Last Modified by:   nam
* @Last Modified time: 2018-10-18 23:40:33
*/
...
int main (int argc, char const *argv[])
{
	...
	while (1) {
		...
		if (0 == strcmp(buff, "0")) { // if pass is wrong < 3 times
			puts("\nPassword is wrong, please input again");
			continue;
		} else if (0 == strcmp(buff, "2")) { // if pass is wrong 3 times
			puts("\nPassword is wrong 3rd time, your account has been locked\n"); 
			return 0;
		} else if (0 == strcmp(buff, "1"))  { // if pass is right
